...
<head>
  ...
  <title>gobuch - consulter les avis</title>
  ...
  <div class="content-wrapper">
   ...
   /*   if(isset($_SESSION['okengdmd'])){   
     ...
     */ ?>
        ...
        <?php   
         $lsql="SELECT * FROM nouscontacter  ORDER BY idcontacter DESC";
           $reponse = $bdd->query($lsql);
           $cpt=0;  
          while ($donnees = $reponse->fetch() )
          {
              $idavis=$donnees['idcontacter'];  
            $contavis=$donnees['contcon'];   $adrip=$donnees['adrip'];
            $dateng=$donnees['date'];
            $heureg=$donnees['heure']; 
     echo "<a href='#'  style='color:black';> <div class='card card-solid'>
        <div class='card-body pb-0'>
      <b>
      Contenu : ".$contavis."<br>";
     // adresse ip : <span class='badge bg-success'>".$adrip."</span><br> 
     echo "Date : ".format($dateng)."<br>
      Heure : ".$heureg."<br>  
