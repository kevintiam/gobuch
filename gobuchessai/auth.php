...
$_SESSION['respenvoi']=0; $_SESSION['idevalv']=0;  $_SESSION['choixevalv']=0;
?>
  ...
  <div class="alert alert-success alert-dismissible">
    ...
    <div class="card-body">
      ...
      <form action="executereq.php" method="post">
        ...
        <input name='nom'  class='form-control' required> </br>
        <label for="exampleInputPassword1">Mot de passe </label>
        <input name='mot' type='password' class='form-control' required> </br>
       ...
       <label for="exampleInputPassword1">LIEU DE RESIDENCE EXACTE</label>
        ...
        <div class="row">
          ...
          <button type="submit" name="loguer" class="btn btn-primary" value="send"> Connecter</button>
