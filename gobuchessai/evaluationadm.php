  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class='card card-solid'>
        ...
        <!-- Small Box (Stat card) -->
        <h5 class="mb-2 mt-4"><a href="evaluationadm.php" class="text-black">Enseignement général</a></h5>
        <div class="row">
    ...
    if($j%12==0){
        ...
        echo "<div class='col-lg-3 col-6'>
            ...
            <a href='#'>         <div class='inner'>
              ...
              <a href='#' class='small-box-footer' data-toggle='dropdown'>
          ...
          while ($don = $rep->fetch()){
            ...
            $nomatiere=nomatiere($idmatiere);
               ...
               echo "<div class='dropdown-divider'></div>
          <a href='evaluation2adm.php?idclassev=".$idclasse."&idcours=".$idmatiere."' class='dropdown-item'>
    ...
    <p class='help-block'>Max. 8MO</p>
       ...
       <div class='modal-footer justify-content-between'>
               <button type='button' class='btn btn-default' data-dismiss='modal'>Fermer</button>";
                echo "<button type='submit' name='ajtevaladm1' class='btn btn-primary'>Ajouter</button>
          </div></form>
     </div>
     <!-- /.modal-content -->
   </div>
