  ...
  <div class="content-wrapper">
   ...
   /*   if(isset($_SESSION['okengdmd'])){   
     ...
     */ ?>
        ...
        <?php   
        $lsql="SELECT * FROM avis  ORDER BY idavis DESC";
           $reponse = $bdd->query($lsql);
           $cpt=0;  
          while ($donnees = $reponse->fetch() )
          {
             $idavis=$donnees['idavis'];  
            $contavis=$donnees['contavis'];   $adrip=$donnees['adrip'];
            $dateng=$donnees['date'];
