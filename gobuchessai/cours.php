...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
      <?php  echo "<form action='lecon.php' method='POST'>"; ?>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a  class="nav-link"  type='button' data-toggle='modal'   data-target='#modaal-success' href="#">
          <i class="fas fa-search"></i> Leçons
          ...
          <div class='modal-dialog'>
            <div class='modal-content'>
              <div class='modal-header'>
                <h4 class='modal-title'>Choisir une autre leçon pour ".$_SESSION['nomatierec']."</h4>
...
<div class="col-md-9"> <?php // normalement <div class="col-md-9"> ?>
  <div class="card card-primary card-outline">
    ...
    <div class="card-body p-0">
      <div class="mailbox-read-info">
        <h5> </h5>
        <h6> 
          <span class="mailbox-read-time float-right"><?php echo datelecon($_SESSION['idleconc']);?></span></h6>
      </div>
      <!-- /.mailbox-read-info -->
...
$v="SELECT * FROM leconimg WHERE idlecon='".$_SESSION['idleconc']."' ORDER BY ordre";
$reponse = $bdd->query($v);
$i=1;
while ($donnees = $reponse->fetch() )
{
  $idleconimg=$donnees['idleconimg'];
  $nomorig=$donnees['imgleconorig'];
  $nomnew=$donnees['imglecon'];
  if(!$isMob){
  echo "<img class='card-img-top' src='lecon/".$nomnew."' alt='lecon'>";
  }
  if($isMob){
echo " <img src='lecon/".$nomnew."' height='700px' width='380px'> </br>";
  $i++;
  }
} 
$reponse->closeCursor();    
      ...
      ?> 
        ...
        <p>
           .</p></br> 
           <?php 
  echo " <iframe width='280' height='235' src='".videolecon($_SESSION['idleconc'])."' title='".$_SESSION['nomleconc']."' frameborder='0' 
                      allow='acceloremeter;autoplay;clipboard-write;encryted-media;gyroscope;picture-in-picture;web-share' allowfullsreen>
                       </iframe>";  ?> 
    ...
    <div class="card-footer bg-white">
      ...
      <a class="btn btn-success" href="repetition.php" data-filter="all"><i class="fas fa-users"></i> Solliciter un(e) enseignant(e)</a>
 ...
 ?>
    ...
    <button class="btn btn-info" type='button' data-toggle='modal'   data-target='#editnote'><small><i class="fas fa-edit"></i> Prendre des notes</small></button>
...
echo "<b>Vous devriez vous connecter pour enregistrer vos notes de cours
  </br></br>
    <div class='btn-group w-100 mb-2'>
...
if(isset($_SESSION['wegonlinenum'])){
  ...
  if($_SESSION['wegonlinenum']!=0){
      echo "<button type='submit' class='btn btn-default' data-dismiss='modal>Fermer</button>
      <button  type='submit' name='enregnote'  value='".idnote($_SESSION['idleconc'],1)."' class='btn btn-primary'>Enregistrer</button>
  ";
      }
 }
   ?>
