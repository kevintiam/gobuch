...
<head>
  ...
  <title>gobuch - Les utilisateurs</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Les utilisateurs   <?php   if(isset($_SESSION['affdatiche'])){ echo $_SESSION['affdatiche'];} ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class='container-fluid'>
        ...
        <div class='card card-solid'>
           <?php    
       echo  "<form action='leskontoacc.php' method='POST'> </br> 
    &nbsp &nbsp &nbsp";
  ...
  <footer class="main-footer">
   <div class="btn-group w-100 mb-2">
    <?php   echo"<a class='btn btn-success' href='kontoensg.php' data-filter='2'><small> Tuteurs</small></a>
                       ...
                       <a class='btn btn-secondary' href='kontonoensg.php' data-filter='2'><small>Non tuteurs</small></a>
      ...
      <div class="modal-dialog">
        <div class="modal-content ">
          <div class="modal-header">
            ...
            <form action='leskontoacc.php' method='POST'>
