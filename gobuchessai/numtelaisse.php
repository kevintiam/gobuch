...
<head>
  ...
  <title>gobuch - consulter les numéros</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Les numéros de téléphone 'prospects'</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
   ...
   /*   if(isset($_SESSION['okengdmd'])){   
     ...
     */ ?>
        ...
        <?php   
        $lsql="SELECT * FROM visiteurlaisse  ORDER BY idvisiteur DESC";
           $reponse = $bdd->query($lsql);
           $cpt=0;  
          while ($donnees = $reponse->fetch() )
          {
            $idvisiteur=$donnees['idvisiteur'];
            $tel=$donnees['tel'];   $adrip=$donnees['adrip'];
            $dateng=$donnees['date'];
