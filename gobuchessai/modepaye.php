...
try 
 ...
 if($q!=0){
    ...
    echo "<label for='inputSpentBudget'>  
    Matière</label>
        
    <div class='select2-purple'>
    <select name='ajtmatev'   class='select2' data-placeholder='Choisir une matière' class='select2'   data-dropdown-css-class='select2-purple' style='width: 100%;'>
    "; 
      

    $matl="SELECT * FROM estenseigne WHERE idclasse='".$q."'";
