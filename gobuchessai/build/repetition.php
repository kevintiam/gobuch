  ...
  <div class="alert alert-success alert-dismissible">
    ...
    <div class="card-body">
      ...
      <form action="emploi.php" method="post">
       ...
       <label for='exampleInputPassword1'>Lieu</label><br><textarea cols='38' rows='3' name='lieu'> </textarea></br></br></br>
       ...
       <label for="exampleInputPassword1">LIEU DE RESIDENCE EXACTE</label>
        ...
        <div class="row">
          ...
          <?php   echo  "<a class='btn btn-danger' href='".$_SESSION['back']."' data-filter='2'><<  retour</a>"; ?>
