...
session_start();
require 'connectC.php'; require 'lesfunction.php'; 
try 
{
...
<head>
  ...
  <title>Cours de répétitions</title>
...
<div class="register-box">
  ...
  <div class="alert alert-success alert-dismissible">
        ...
        <img src="image4.jpg" alt="user-avatar" height="130px" width="330px">
       
    </div>
    <div class="card-body">
      <p class="login-box-msg"><B>Veuillez remplir le formulaire, puis cliquer sur enregistrer</B></p>

      <form action="index.php" method="post">
        <label for="exampleInputPassword1">CLASSES SOLLICITEES </label>
        <div class="select2-purple">
        <select name="clas[]" multiple="multiple" data-placeholder="Cliquer ici  pour choisir les classes" class="form-control select2" style="width: 100%;" id="exampleInputPassword1" >
        <?php 
                    
                     $reponse = $bdd->query("SELECT * FROM repetitionclasse WHERE sup='0'");
        ...
        <div class="input-group mb-3">
        <select name="ville"    class="form-control" style="width: 100%;" id="exampleInputPassword1" >
        <?php 
       ...
       <label for="exampleInputPassword1">LIEU DE RESIDENCE EXACTE</label>
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="input-group mb-3">
            <button type="submit" name="envoi" class="btn btn-primary btn-block" value="send">Enregistrer</button>
          </div>
          <!-- /.col -->
        </div>
