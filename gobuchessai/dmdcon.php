...
<div class="register-box">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <!--form action="connexionauth.php" method="post"-->
       <form action="executereq.php" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" name="konnacco" class="btn btn-primary btn-block">Valider</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      ...
      <ul>
      <li><a href="logincreat2.php" class="text-center">Je veux creer un compte gobuch</a></li></br>
