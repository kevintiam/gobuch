...
<div class="register-box">
  ...
  <div class="alert alert-success alert-dismissible">
    ...
    <div class="card-body">
      <p class="login-box-msg"><B>Vous devriez créer un compte pour confirmer votre demande</B></p>
      ...
      <label for="exampleInputPassword1">Nom*</label>
        ...
        <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lg fa-phone">+237</span>
            </div>
          </div>
        ...
        <div class="input-group mb-3">
          <input name="motp" class="form-control" required >
        </div-->
       ...
       <label for="exampleInputPassword1">LIEU DE RESIDENCE EXACTE</label>
        ...
        <div class="row">
          ...
          <a class="btn btn-danger" href="emploi.php" data-filter="2"><<  retour</a>
          <button type="submit" name="confirmer" class="btn btn-success" value="send"> confirmer >></button>
