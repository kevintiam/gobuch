...
<head>
  ...
  <title>Enseignement général-gobuch-les matières</title>
          ...
          <div class='modal-dialog'>
            <div class='modal-content'>
              <div class='modal-header'>
                <h4 class='modal-title'>Choisir une classe</h4>
    ...
    <section class="content">
      ...
      <div class="card card-solid">
        ...
        <b>Choisir une classe</b> 
         ...
         <?php  
         //if(empty($_SESSION['classec']) AND isset($_SESSION['classec'])){
      ...
      <button type='submit' name='rechclasse' style='width: 100%; height: 5%;' class='btn btn-info active'>Rechercher</button>                  
        ...
        <!-- Small Box (Stat card) -->
        <h5 class="mb-2 mt-4"><a href="programmegen.php" class="text-black">Enseignement général</a></h5>
        <div class="row">
          
        <?php $j=0;  $p=0;
        $isMob=is_numeric(strpos(strtolower($_SERVER['HTTP_USER_AGENT']),"mobile"));
        if($_SESSION['classec']!=0){ 
...
if($j>=1){ 
    ...
    if($j%12==0){
        ...
        echo "<div class='col-lg-3 col-6'>
            ...
            <div class='".$color."'>";
 if($joink==0){
              echo "<a href='#' class='small-box-footer' type='button' data-toggle='modal'   data-target='".$moda."'>";
 }
 if($joink==1){
              echo "<a href='".$lienk."&see=".$_SESSION['classec']."' class='small-box-footer' type='button'>";
 }
              echo "<div class='inner'>
                <h5>".$_SESSION['nomclassec']."</h5>
              ...
              if($joink==0){
              echo "<a href='#' class='small-box-footer' type='button' data-toggle='modal'   data-target='".$moda."'>
                voir les chapitres <i class='fas fa-arrow-circle-right'></i>
              </a>"; 
                  }
                  if($joink==1){
              echo "<a href='".$lienk."&see=".$_SESSION['classec']."' class='small-box-footer' type='button'>
        ...
        echo " 
          ...
          <div class='modal-dialog'>
            <div class='modal-content'>
              <div class='modal-header'>
                <h4 class='modal-title'>Choisir un chapitre en ".$nomatiere."</br>".$_SESSION['nomclassec']."</h4>
    ...
    <div class='modal-body'>";
          ...
          while ($don = $rep->fetch()){
            ...
            if(!$isMob){ 
               echo "<div class='dropdown-divider'></div>
          <a href='lecon.php?idclasse=".$_SESSION['classec']."&idcours=".$idmatiere."&idchap=".$idchapitre."' class='dropdown-item'>
          <b>".$ord." . ".couperchapi2($nomchapitre)."</b>
             
          </a>";  }
          if($isMob){ 
            echo "<div class='dropdown-divider'></div>
       <a href='lecon.php?idclasse=".$_SESSION['classec']."&idcours=".$idmatiere."&idchap=".$idchapitre."' class='dropdown-item'>
       <b>".$ord." . ".couperchapi3($nomchapitre)."</b>
