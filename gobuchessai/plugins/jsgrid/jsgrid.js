    ...
    Grid.prototype = {
        ...
        _createFilterRow: function() {
            ...
            this._eachField(function(field) {
                this._prepareCell("<td><B>", field, "filtercss")
        ...
        _createInsertRow: function() {
            ...
            this._eachField(function(field) {
                this._prepareCell("<td><B>", field, "insertcss")
        ...
        _createNoDataRow: function() {
            ...
            return $("<tr>").addClass(this.noDataRowClass)
                .append($("<td><B>").addClass(this.cellClass).attr("colspan", amountOfFields)
        ...
        _createCell: function(item, field) {
            ...
            if($.isFunction(field.cellRenderer)) {
                ...
                $result = $("<td><B>").append(this.renderTemplate(field.itemTemplate || fieldValue, field, args));
            }
        ...
        _createEditRow: function(item) {
            ...
            this._eachField(function(field) {
                ...
                this._prepareCell("<td><B>", field, "editcss")
