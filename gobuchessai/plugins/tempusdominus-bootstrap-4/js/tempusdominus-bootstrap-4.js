  ...
  var TempusDominusBootstrap4 = /*#__PURE__*/function (_DateTimePicker) {
      ...
      for (i = 0; i < 42; i++) {
        ...
        if (currentDate.weekday() === 0) {
          ...
          if (this._options.calendarWeeks) {
            row.append("<td class=\"cw\">" + currentDate.week() + "</B></td> ");
          }
        ...
        row.append("<td data-action=\"selectDay\" data-day=\"" + currentDate.format('L') + "\" class=\"day" + clsName + "\">" + currentDate.date() + "</B></td> ");
        currentDate.add(1, 'd');
      }
    ...
    _proto2._fillHours = function _fillHours() {
      ...
      while (currentHour.isSame(this._viewDate, 'd') && (this.use24Hours || this._viewDate.hour() < 12 && currentHour.hour() < 12 || this._viewDate.hour() > 11)) {
        ...
        row.append("<td data-action=\"selectHour\" class=\"hour" + (!this._isValid(currentHour, 'h') ? ' disabled' : '') + "\">" + currentHour.format(this.use24Hours ? 'HH' : 'hh') + "</B></td> ");
        currentHour.add(1, 'h');
      }
    ...
    _proto2._fillMinutes = function _fillMinutes() {
      ...
      while (this._viewDate.isSame(currentMinute, 'h')) {
        ...
        row.append("<td data-action=\"selectMinute\" class=\"minute" + (!this._isValid(currentMinute, 'm') ? ' disabled' : '') + "\">" + currentMinute.format('mm') + "</B></td> ");
    ...
    _proto2._fillSeconds = function _fillSeconds() {
      ...
      while (this._viewDate.isSame(currentSecond, 'm')) {
        ...
        row.append("<td data-action=\"selectSecond\" class=\"second" + (!this._isValid(currentSecond, 's') ? ' disabled' : '') + "\">" + currentSecond.format('ss') + "</B></td> ");
