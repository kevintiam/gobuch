  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Organiser les leçons</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
$v="SELECT * FROM leconimg WHERE idlecon='".$_SESSION['idleconbild']."' ORDER BY ordre";
$reponse = $bdd->query($v);
$i=1;
while ($donnees = $reponse->fetch() )
{
  ...
  $ligne='ligne'.$i;   $chpid='chpid'.$i;
    $modadang1='modaal-danger'.$i;
      echo "<div class='card card-solid'>
        ...
        <button class='btn btn-danger' type='submit'  name='deletebild' value='".$idleconimg."'>Supprimer</button>
        <button class='btn btn-primary' type='button'>Numéro</button>
        <input name='".$ligne."' value='".$order."'>
       
        </div></br><img src='lecon/".$nomnew."' height='700px' width='380px'> 
      </center> 
        </div> 
      </div>";
     $i++;
 ...
 <!-- =========================================================== -->
  ...
  <div class="btn-group w-100 mb-2">
      ...
      <button class='btn btn-success' name='subimage' value='".$i."' type='submit'>Enregistrer les numéros</button>";
  ...
  <div class="modal-dialog">
    <div class="modal-content ">
      <div class="modal-header">
        <h4 class="modal-title">Ajouter les images  </h4>
...
";
 ?> 
      ...
      <div class="modal-footer justify-content-right">
       ...
       <button type="submit" name="ajtimglecon" value=" " class="btn btn-primary"> Ajouter les images</button> 
