...
/*
require 'connectC.php';  require 'lesmenus.php'; require 'lesmenushoriz2.php';
...
<link rel="stylesheet" href="plugins/select2/css/select2.min.css">
  ...
  <script>
    ...
    function temps(str){
         if(str==" "){
             document.getElementById("yess").innerHTML=" ";
             return ;
         }
         else{
             ...
             xmlhttp.onreadystatechange=function(){
                 if(this.readyState==4 && this.status==200 ){
                     document.getElementById("yess").innerHTML=this.responseText;
                 }
             };
             xmlhttp.open("POST","rand.php",true);
             xmlhttp.send();
         }
     }
     </script>
...
<button type='submit' name='envoinum' class='btn btn-success' value='send'>OK</button>
 ...
 if($_SESSION['temps']>=0){ 
// echo "<b>Chronomètre : ".$_SESSION['temps']--." secondes</b>";
echo "<b>Vous avez 15 secondes pour saisir votre numéro</b>";
