...
if(isset($_POST['researvi'])){
  $_SESSION['viresearc']=$_POST['ville'];  
  $_SESSION['posgeo']=1;
  }     

if(isset($_POST['researqu'])){
  $_SESSION['qtresearc']=$_POST['qtier'];  
  $_SESSION['posgeo']=2;
  }    
...
<head>
  ...
  <title>gobuch - Les utilisateurs tuteurs</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Les utilisateurs tuteurs  <?php   if(isset($_SESSION['affdatiche'])){ echo $_SESSION['affdatiche'];} ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class='container-fluid'>
        ...
        <div class='card card-solid'>
           <?php    
       echo  "<form action='kontoensg.php' method='POST'> </br> 
    &nbsp &nbsp &nbsp";
    ...
    echo "</form>";
    if($_SESSION['posgeo']==1){
echo "<b> &nbsp &nbsp  Ville : ".$_SESSION['viresearc']."</b>";
    }
    if($_SESSION['posgeo']==2){
echo "<b> &nbsp &nbsp  Quartier : ".$_SESSION['qtresearc']."</b>";
    }
...
if($_SESSION['posgeo']==1){ // VILLE
      
     $verifviensg=verifviensg($idutilisateur,$_SESSION['viresearc']);
     if($verifviensg!=0){ 
     echo "<div class='col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column' style='color:black';> <div class='card card-solid'>
        <div class='card-body pb-0 '>
      <b>
       
      Noms et prénoms : &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp   <a class='badge bg-success' style='color:black'; type='button' href='leskontodet.php?id=".$idutilisateur."'>&nbsp &nbsp <i class='fas fa-pencil-alt'></i>&nbsp &nbsp</a><br>
       ".$nom." ".$prenom."  <br> 
     Date de naissance : <span class='badge bg-info'>".$datenaiss."</span><br> 
     Genre : <span class='badge bg-primary'>".genre($genre)." </span><br>
Téléphone :<br> ".$numtelsimpl."<br>
Téléphone Whatsapp : <br>".$numtelwh."<br>
 Ville : ".$_SESSION['viresearc']."<br>
 Quartier : ".qtierensg($idutilisateur)."<br>
Date d'enregistrement : <br>".format($date)." ".$heure."<br>
 <small>ID utilisateur : ".$idutilisateur."</small><br>";
 echo " </b>"; 
echo "</br>
...
if($_SESSION['posgeo']==2){ // Quartier
      
     $verifqtensg=verifqtensg($idutilisateur,$_SESSION['qtresearc']);
     if($verifqtensg!=0){       
     echo "<div class='col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column' style='color:black';> <div class='card card-solid'>
        <div class='card-body pb-0 '>
      <b>
...
Téléphone :<br> ".$numtelsimpl."<br>
Téléphone Whatsapp : <br>".$numtelwh."<br>
 Quartier : ".$_SESSION['qtresearc']."<br>
 Ville : ".vilensg($idutilisateur)."<br>
Date d'enregistrement : <br>".format($date)." ".$heure."<br>
 <small>ID utilisateur : ".$idutilisateur."</small><br>";
 echo " </b>"; 
echo "</br>
...
<nav class="main-header navbar navbar-expand navbar-dark">
  <footer class="main-footer">
   <div class="btn-group w-100 mb-2">
    <?php   echo"<a class='btn btn-success' href='kontonoensg.php' data-filter='2'><small> Non tuteurs</small></a>
      ...
      <div class="modal-dialog">
        <div class="modal-content ">
          <div class="modal-header">
            ...
            <form action='kontoensg.php' method='POST'>
...
<div class="modal-body">
     ...
     <?php 
     echo "<p><div class='form-group'><div class='select2-purple'>
<label for='exampleInputPassword1'>Tuteur </label>
...
<select name='ville'   class='select2' data-dropdown-css-class='select2-purple' style='width: 100%;'> "; 
 
 
$chapav="SELECT DISTINCT ville FROM enseignant ORDER BY ville";
$repav = $bdd->query($chapav);
while ($donav = $repav->fetch()){
...
echo "</select></div><br>
 <div class='btn-group w-100 mb-2'>
<button class='btn btn-primary' type='submit' name='researvi'>Valider</button>             
...
echo "<p><div class='form-group'><div class='select2-purple'>
<label for='exampleInputPassword1'>Quartier [Ville] </label>
<select name='qtier'   class='select2' data-dropdown-css-class='select2-purple' style='width: 100%;'> "; 
 
 
$chapav="SELECT quartier,ville FROM enseignant ORDER BY quartier";
$repav = $bdd->query($chapav);
while ($donav = $repav->fetch()){
$ville=$donav['ville'];
 $qtier=$donav['quartier'];
echo "<option value='".$qtier."'>".$qtier." [ ".$ville." ]</option>";
...
echo "</select></div><br>
 <div class='btn-group w-100 mb-2'>
<button class='btn btn-primary' type='submit' name='researqu'>Valider</button>             
