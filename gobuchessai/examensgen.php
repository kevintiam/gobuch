  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card card-solid">
        ...
        <center>
        <form action='examensgen.php' method='POST'>  
      ...
      <button type='submit' name='rechclasse' style='width: 100%; height: 5%;' class='btn btn-info active'>Rechercher</button>                  
        ...
        <!-- Small Box (Stat card) -->
        <h5 class="mb-2 mt-4"><a href="examensgen.php" class="text-black">Enseignement général</a></h5>
        <div class="row">
...
if($j>=1){ 
    ...
    if($j%12==0){
        ...
        echo "<div class='col-lg-3 col-6'>
            <!-- small card -->
            <div class='".$color."'>
            <a href='#' class='small-box-footer'  data-toggle='modal'   data-target='".$moda."'>         <div class='inner'>
                   <h5>&nbsp".$_SESSION['nomclassec']."</h5>

                <p><b> &nbsp&nbsp".$nomatiere."</b></p>
                  </div>   </a>
              <div class='icon'>
 ...
 <!-- =========================================================== -->
  ...
  <div class="btn-group w-100 mb-2">
     ...
     <?php  
     $admin=0;
    /* if($admin==0 AND $_SESSION['classec']!=0){
    ...
    <p class='help-block'>Max. 8MO</p>
       ...
       <div class='modal-footer justify-content-between'>
               <button type='button' class='btn btn-default' data-dismiss='modal'>Fermer</button>";
                echo "<button type='submit' name='ajtexam' class='btn btn-primary'>Ajouter</button>
          </div>
     </div></form>
     <!-- /.modal-content -->
   </div>
