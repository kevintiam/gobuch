...
<div class="register-box">
  <div class="register-logo">
    <a href="#"><b>JE CREE MON COMPTE GOBUCH</b></a>
  </div>
    ...
    <div class="card-body register-card-body">
      ...
      <!--form action="connexionauth.php" method="post"-->
       ...
       <div class="input-group mb-3">
        ...
        <div class="input-group mb-3">
          <input type="password" name="passmot" class="form-control" required>
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" name="conncreat" class="btn btn-primary btn-block">Valider</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      ...
      <ul>
      <li><a href="login.php" class="text-center">Je veux me connecter sur mon compte gobuch</a></li></br>
