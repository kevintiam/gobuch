...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
      <?php  echo "<form action='examensgen.php' method='POST'>"; ?>
      ...
      <li class="nav-item dropdown">
        ...
        while ($donnees = $reponse->fetch()){
          ...
          $nomatiere=nomatiere($idmatiere);
            ...
            <a href='examensgen2.php?idcoursmat=".$idmatiere."' class='dropdown-item'>
     ...
     <div class='modal-header'>
       ...
       <div class='modal-footer justify-content-between'>
               <button type='button' class='btn btn-default' data-dismiss='modal'>Fermer</button>";
                echo "<button type='submit' name='supexam' class='btn btn-danger' value='".$idsession."'>Supprimer</button>
          </div>
     </div></form>
     <!-- /.modal-content -->
   </div>
