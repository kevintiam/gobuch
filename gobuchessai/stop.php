...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center"  style='background-color:#F6F2E8';>
      ...
      <?php  echo "<form action='seance.php' method='POST'>"; ?>
  ...
  <div class="alert alert-success alert-dismissible">
    ...
    <div class="card-body" >
      <p class="login-box-msg"><B>Terminer la séance</B></p>
 ...
 <?php 
  echo "<form  method='POST' action='executereq.php'>";
    ...
    <?php if($_GET['stop']>0){  
     ...
     echo "<button type='submit' name='finseanc' value='".$_GET['stop']."' class='btn btn-primary'>Enregistrer</button>";
       } ?> </div>
</form>
